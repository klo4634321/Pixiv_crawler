...
def download():
    ...
    max_artworks = int(request.form['max_artworks']) if request.form['max_artworks'].isdigit() else 5

    # 創建下載器並執行
    downloader = PixivSimpleSeleniumDownloader(username, password, artist_id)
    result = downloader.run(max_artworks)
